...
public class TestJUnit extends TestCase {
	...
	public static final String syntax = (System.getenv("SWIPL_SYNTAX") == null ? "traditional" : System.getenv("SWIPL_SYNTAX"));
	...
	public void testSyntaxSet1() {
		if (syntax.equals("traditional")) {
			...
			try {
				JPL.setTraditional();
			} catch (jpl.JPLException e) { // expected exception class, but is it correct in detail?
	...
	// public void testSwiPrologHome() {
	// System.out.println("home = " + Query.oneSolution("current_prolog_flag(home,Home)").get("Home"));
	// }

	// public void testSwiPrologVersion() {
	...
	public void testGoalWithModulePrefix3() {
		...
		} catch (jpl.PrologException e) { // expected exception class
	...
	public void testGoalWithModulePrefix5() {
		...
		} catch (jpl.PrologException e) { // correct exception class
			if (e.term().hasFunctor("error", 2) && e.term().arg(1).hasFunctor("type_error", 2) && e.term().arg(1).arg(1).hasFunctor("atom", 0)) {
				// OK: an appropriate exception was thrown
			} else {
	...
	public void testStringXput1() {
		...
		assertEquals("string", a.blobType());
	}
	...
	public void testStaticQueryInvalidSourceText2() {
		...
		} catch (jpl.PrologException e) { // expected exception
	...
	public void testRef7() {
		...
		} catch (jpl.JPLException e) { // expected exception class
